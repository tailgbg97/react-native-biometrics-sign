...
| `react-native-biometrics-sign` version | Required React Native Version |
|:---------------------------------:|:-----------------------------:|
| `>= 2.0.0`                        | `>= 0.60`                     |
| `<= 1.7.0`                        | `<= 0.59.x`                   |
...
`yarn add react-native-biometrics-sign`

or npm:

`$ npm install react-native-biometrics-sign --save`
...
![react-native-biometrics-sign](https://2.bp.blogspot.com/-Lp2zaAZietw/Vi59hb6k6SI/AAAAAAAABLk/HsXXBYiIwqU/s1600/image01.png)
...
```js
import ReactNativeBiometrics, { BiometryTypes } from 'react-native-biometrics-sign'
...
```js
import ReactNativeBiometrics from 'react-native-biometrics-sign'
...
let payload = 'MIICYjCCAUoCAQAwHTELMAkGA1UEBh......' // base64 string
